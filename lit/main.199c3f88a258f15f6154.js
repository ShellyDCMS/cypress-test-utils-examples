...
let PokemonCatalogComponent = class extends lit__WEBPACK_IMPORTED_MODULE_3__.LitElement {
  constructor() {
    ...
    this.loadPokemon = async () => this.pokemon = await this.pokemonService.getPokemon();
...
class PokemonInternalService {
  constructor() {
    this.baseUrl = "https://pokeapi.co/api/v2/pokemon/?limit=1";
    this.getPokemon = async (url = this.baseUrl) => await (await fetch(url)).json();
  }
}
