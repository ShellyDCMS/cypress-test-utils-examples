...
/* harmony import */ var _pokemon_catalog_component_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pokemon-catalog.component.scss */ "./src/components/pokemon-catalog/pokemon-catalog.component.scss");
...
let PokemonCatalogComponent = class extends lit__WEBPACK_IMPORTED_MODULE_1__.LitElement {
  constructor() {
    super();
    ...
    this.getPokemonIndex = () => this.pokemon?.results[0].url.split("/").filter((element) => element).pop();
    this.getPokemonName = () => this.pokemon?.results[0].name;
    this.getPokemonImage = () => `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${this.getPokemonIndex()}.png`;
  }
  static get styles() {
    return _pokemon_catalog_component_scss__WEBPACK_IMPORTED_MODULE_4__["default"];
  }
  connectedCallback() {
    super.connectedCallback();
    new _lit_labs_context__WEBPACK_IMPORTED_MODULE_0__.ContextConsumer(
      this,
  ...
  render() {
    return !this.pokemon ? "" : lit__WEBPACK_IMPORTED_MODULE_1__.html`
          <div class="catalog">
...
PokemonCatalogComponent = __decorateClass([
  (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_2__.customElement)("pokemon-catalog")
...
const styles = lit__WEBPACK_IMPORTED_MODULE_0__.css`:host{display:flex}.catalog{display:flex;flex-direction:column;align-self:center;align-items:center;width:100vw}.pokemon{height:10rem}`;
